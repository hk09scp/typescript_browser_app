...
class Application {
    constructor() {
        this.eventListner = new _EventListener__WEBPACK_IMPORTED_MODULE_0__.EventListener(); //リスナークラス
        this.taskCollection = new _TaskCollection__WEBPACK_IMPORTED_MODULE_2__.TaskCollection(); //タスククラス
        this.taskRenderer = new _TaskRenderer__WEBPACK_IMPORTED_MODULE_3__.TaskRenderer(document.getElementById('todoList'), document.getElementById('doingList'), document.getElementById('doneList')); //HTML要素
        //タスクを作成
        this.handleSubmit = (e) => {
            e.preventDefault();
